...
public class SlimeEntityMagenta extends SlimeEntityColoured {

    public SlimeEntityMagenta(EntityType<? extends SlimeEntityMagenta> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_MAGENTA));
    }

    public static final EntityType<SlimeEntityMagenta> SLIME_ENTITY_MAGENTA = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier(Slimeology.MOD_ID, "slime_entity_magenta"),
            FabricEntityTypeBuilder.<SlimeEntityMagenta>create(SpawnGroup.MONSTER, SlimeEntityMagenta::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_MAGENTA;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECMagenta(EntityType<? extends SlimeEntityMagenta> type, WorldAccess world, SpawnReason spawnReason,
