...
public class SlimeEntityBlack extends SlimeEntityColoured {

    public SlimeEntityBlack(EntityType<? extends SlimeEntityBlack> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_BLACK));
    }

    public static final EntityType<SlimeEntityBlack> SLIME_ENTITY_BLACK = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier(Slimeology.MOD_ID, "slime_entity_black"),
            FabricEntityTypeBuilder.<SlimeEntityBlack>create(SpawnGroup.MONSTER, SlimeEntityBlack::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_BLACK;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECBlack(EntityType<? extends SlimeEntityBlack> type, WorldAccess world, SpawnReason spawnReason,
