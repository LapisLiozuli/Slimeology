...
public class SlimeEntityRed extends SlimeEntityColoured {

    public SlimeEntityRed(EntityType<? extends SlimeEntityRed> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_RED));
    }

    public static final EntityType<SlimeEntityRed> SLIME_ENTITY_RED = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier(Slimeology.MOD_ID, "slime_entity_red"),
            FabricEntityTypeBuilder.<SlimeEntityRed>create(SpawnGroup.MONSTER, SlimeEntityRed::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_RED;


// Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECRed(EntityType<? extends SlimeEntityRed> type, WorldAccess world, SpawnReason spawnReason,
