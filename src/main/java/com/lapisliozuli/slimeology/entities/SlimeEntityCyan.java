...
public class SlimeEntityCyan extends SlimeEntityColoured {

    public SlimeEntityCyan(EntityType<? extends SlimeEntityCyan> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_CYAN));
    }

    public static final EntityType<SlimeEntityCyan> SLIME_ENTITY_CYAN = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier(Slimeology.MOD_ID, "slime_entity_cyan"),
            FabricEntityTypeBuilder.<SlimeEntityCyan>create(SpawnGroup.MONSTER, SlimeEntityCyan::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_CYAN;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECCyan(EntityType<? extends SlimeEntityCyan> type, WorldAccess world, SpawnReason spawnReason,
