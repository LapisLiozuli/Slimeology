...
public class SlimeEntityPurple extends SlimeEntityColoured {

    public SlimeEntityPurple(EntityType<? extends SlimeEntityPurple> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_PURPLE));
    }

    public static final EntityType<SlimeEntityPurple> SLIME_ENTITY_PURPLE = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier(Slimeology.MOD_ID, "slime_entity_purple"),
            FabricEntityTypeBuilder.<SlimeEntityPurple>create(SpawnGroup.MONSTER, SlimeEntityPurple::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_PURPLE;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECPurple(EntityType<? extends SlimeEntityPurple> type, WorldAccess world, SpawnReason spawnReason,
