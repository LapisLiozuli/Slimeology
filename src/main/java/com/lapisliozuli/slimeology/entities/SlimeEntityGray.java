...
public class SlimeEntityGray extends SlimeEntityColoured {

    public SlimeEntityGray(EntityType<? extends SlimeEntityGray> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return SlimeEntityColouredParticles.SLIME_PARTICLE_GRAY;
    }
    ...
    public static final EntityType<SlimeEntityGray> SLIME_ENTITY_GRAY = Registry.register(
            ...
            FabricEntityTypeBuilder.<SlimeEntityGray>create(SpawnGroup.MONSTER, SlimeEntityGray::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_GRAY;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECGray(EntityType<? extends SlimeEntityGray> type, WorldAccess world, SpawnReason spawnReason,
