...
public class SlimeEntityLightGray extends SlimeEntityColoured {

    public SlimeEntityLightGray(EntityType<? extends SlimeEntityLightGray> arg, World arg2) {
        super(arg, arg2);
    }

    @Override
    protected ParticleEffect getParticles() {
        return new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(RegisterItems.SLIME_BALL_LIGHT_GRAY));
    }
    ...
    public static final EntityType<SlimeEntityLightGray> SLIME_ENTITY_LIGHT_GRAY = Registry.register(
            ...
            FabricEntityTypeBuilder.<SlimeEntityLightGray>create(SpawnGroup.MONSTER, SlimeEntityLightGray::new)
                    .dimensions(EntityDimensions.changing(2.04f, 2.04f))
                    .trackable(160,4).build());

    public static final EntityType secPointer = SLIME_ENTITY_LIGHT_GRAY;


    // Adapted from SlimeEntityColoured.canSpawnSEC()
    public static boolean canSpawnSECLightGray(EntityType<? extends SlimeEntityLightGray> type, WorldAccess world, SpawnReason spawnReason,
