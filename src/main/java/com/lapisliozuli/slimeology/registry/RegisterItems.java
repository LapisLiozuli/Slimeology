...
public class RegisterItems {
    ...
    public static final Item SLIME_WHITE_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_WHITE, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_ORANGE_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_ORANGE, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_MAGENTA_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_MAGENTA, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_LIGHT_BLUE_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_LIGHT_BLUE, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_YELLOW_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_YELLOW, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_LIME_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_LIME, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_PINK_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_PINK, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_GRAY_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_GRAY, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_LIGHT_GRAY_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_LIGHT_GRAY, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_CYAN_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_CYAN, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_PURPLE_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_PURPLE, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BLUE_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_BLUE, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BROWN_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_BROWN, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_GREEN_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_GREEN, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_RED_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_RED, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BLACK_SPAWN_EGG = new SpawnEggItem(RegisterSEC.SLIME_ENTITY_BLACK, 0xFF00FF, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));
