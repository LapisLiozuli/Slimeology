...
public class SpawnEggSlime {
    ...
    public static final Item SLIME_YELLOW_SPAWN_EGG = new SpawnEggItem(SlimeEntityYellow.SLIME_ENTITY_YELLOW, 0xFFD248, 0xD9B318, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_LIME_SPAWN_EGG = new SpawnEggItem(SlimeEntityLime.SLIME_ENTITY_LIME, 0x8BC42B, 0x5EA500, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_PINK_SPAWN_EGG = new SpawnEggItem(SlimeEntityPink.SLIME_ENTITY_PINK, 0xFE88B6, 0xD16986, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_GRAY_SPAWN_EGG = new SpawnEggItem(SlimeEntityGray.SLIME_ENTITY_GRAY, 0x4F4F4F, 0x2B2B2B, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_LIGHT_GRAY_SPAWN_EGG = new SpawnEggItem(SlimeEntityLightGray.SLIME_ENTITY_LIGHT_GRAY, 0x9E9E9E, 0x7B7B7B, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_CYAN_SPAWN_EGG = new SpawnEggItem(SlimeEntityCyan.SLIME_ENTITY_CYAN, 0x2199A8, 0x007A78, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_PURPLE_SPAWN_EGG = new SpawnEggItem(SlimeEntityPurple.SLIME_ENTITY_PURPLE, 0x942FC4, 0x671094, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BLUE_SPAWN_EGG = new SpawnEggItem(SlimeEntityBlue.SLIME_ENTITY_BLUE, 0x4741B6, 0x1A2286, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BROWN_SPAWN_EGG = new SpawnEggItem(SlimeEntityBrown.SLIME_ENTITY_BROWN, 0x8E513E, 0x61320E, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_GREEN_SPAWN_EGG = new SpawnEggItem(SlimeEntityGreen.SLIME_ENTITY_GREEN, 0x697922, 0x2C5A00, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_RED_SPAWN_EGG = new SpawnEggItem(SlimeEntityRed.SLIME_ENTITY_RED, 0xBB2B32, 0x8E0C02, new Item.Settings().group(Slimeology.SLIMEOLOGY));
    public static final Item SLIME_BLACK_SPAWN_EGG = new SpawnEggItem(SlimeEntityBlack.SLIME_ENTITY_BLACK, 0x1F1F1F, 0x000000, new Item.Settings().group(Slimeology.SLIMEOLOGY));

    public static void registerSpawnEggSlime() {
